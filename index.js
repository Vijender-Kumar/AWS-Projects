...
const MONGODB_URI =
    "mongodb+srv://mongod:mongod@aws-lambda-v1.nsytg.mongodb.net/?retryWrites=true&w=majority";
...
async function connectToDatabase() {
    ...
    const db = await client.db("sample_digitap");
...
exports.handler = async (event, context) => {
	...
	// const result = await db.collection("listDigitap").find({}).limit(20).toArray();
    const result = await db.collection("listDigitap").insertOne(event);
